...
pub mod hello_world_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn say_hello(
            ...
            req.extensions_mut().insert(GrpcMethod::new("hello.HelloWorld", "SayHello"));
...
pub mod hello_world_server {
    ...
    #[async_trait]
    pub trait HelloWorld: std::marker::Send + std::marker::Sync + 'static {
        async fn say_hello(
            &self,
                ...
                "/hello.HelloWorld/SayHello" => {
                    ...
                    for SayHelloSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as HelloWorld>::say_hello(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for HelloWorldServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "hello.HelloWorld";
    impl<T> tonic::server::NamedService for HelloWorldServer<T> {
